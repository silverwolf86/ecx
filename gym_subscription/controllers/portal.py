...
from odoo.addons.gym_subscription.models.sale_order import SUBSCRIPTION_PROGRESS_STATE, SUBSCRIPTION_CLOSED_STATE
...
class CustomerPortal(payment_portal.PaymentPortal):
    ...
    def my_subscription(self, page=1, date_begin=None, date_end=None, sortby=None, filterby=None, order_id=None, **kw):
        ...
        return request.render("gym_subscription.portal_my_subscriptions", values)
    ...
    def subscription(self, order_id, access_token=None, message='', report_type=None, download=False, payment_amount=None, **kw):
        ...
        action = request.env.ref('gym_subscription.sale_subscription_action')
        ...
        return request.render("gym_subscription.subscription_portal_template", rendering_context)
