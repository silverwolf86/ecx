...
registry.category("web_tour.tours").add('sale_subscription_tour', {
    url: "/odoo",
    steps: () => [{
    trigger: '.o_app[data-menu-xmlid="gym_subscription.menu_sale_subscription_root"]',
	content: _t('Want a recurring billing through subscription management? Get started by clicking here'),
    tooltipPosition: 'bottom',
    run: "click",
},
{
    trigger: '.dropdown-toggle[data-menu-xmlid="gym_subscription.product_menu_catalog"]',
    content: _t('Let\'s go to the catalog to create our first subscription product'),
    tooltipPosition: 'bottom',
    run: "click",
},
{
    trigger: '.dropdown-item[data-menu-xmlid="gym_subscription.menu_sale_subscription_product"]',
...
{
    trigger: '.dropdown-toggle[data-menu-xmlid="gym_subscription.menu_sale_subscription"]',
    content: _t('Go back to the subscription view'),
    tooltipPosition: 'bottom',
    run: "click",
},
{
    trigger: '.dropdown-item[data-menu-xmlid="gym_subscription.menu_sale_subscription_action"]',
    content: _t('Go back to the subscription view'),
    tooltipPosition: 'right',
    run: "click",
},
