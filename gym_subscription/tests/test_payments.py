...
from odoo.addons.gym_subscription.tests.common_sale_subscription import TestSubscriptionCommon
...
class TestSubscriptionPayments(PaymentCommon, TestSubscriptionCommon, MockEmail):
    ...
    def test_auto_payment_with_token(self):
        ...
        with patch('odoo.addons.gym_subscription.models.sale_order.SaleOrder._do_payment', wraps=self._mock_subscription_do_payment):
    ...
    @mute_logger('odoo.addons.gym_subscription.models.sale_order')
    def test_exception_mail(self):
        ...
        self.subscription.action_confirm()
        with patch('odoo.addons.gym_subscription.models.sale_order.SaleOrder._do_payment', side_effect=Exception("Bad Token")), self.mock_mail_gateway():
    ...
    def test_bad_payment_exception(self):
        ...
        with patch('odoo.addons.gym_subscription.models.sale_order.SaleOrder._do_payment', side_effect=Exception("Oops, network error")),\
    ...
    def test_bad_payment_exception_post_success(self):
        ...
        with patch('odoo.addons.gym_subscription.models.sale_order.SaleOrder._do_payment', wraps=_mock_subscription_do_payment_and_commit),\
             patch('odoo.addons.gym_subscription.models.sale_order.SaleOrder._subscription_post_success_payment', side_effect=Exception("Kaput")),\
             self.mock_mail_gateway():
    ...
    def test_bad_payment_rejected(self):
        ...
        with patch('odoo.addons.gym_subscription.models.sale_order.SaleOrder._do_payment', wraps=self._mock_subscription_do_payment_rejected),\
             self.mock_mail_gateway():
            self.subscription._create_recurring_invoice()
    ...
    def test_close_unpaid_contracts(self):
        ...
        with freeze_time("2022-05-02"):
            ...
            self.assertEqual(sub3.close_reason_id.id, self.env.ref("gym_subscription.close_reason_unpaid_subscription").id)
    ...
    def test_close_unpaid_contracts_bis(self):
        ...
        with freeze_time("2025-01-07"):
            ...
            self.assertEqual(sub.close_reason_id.id, self.env.ref("gym_subscription.close_reason_auto_close_limit_reached").id)
    ...
    def test_payment_pending(self):
        ...
        self.subscription.action_confirm()
        with patch('odoo.addons.gym_subscription.models.sale_order.SaleOrder._do_payment', wraps=self._mock_subscription_do_payment_pending),\
             self.mock_mail_gateway():
            self.subscription._create_recurring_invoice()
