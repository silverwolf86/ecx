...
from odoo.addons.gym_subscription.tests.test_sale_subscription import TestSubscription
...
class TestSubscriptionInvoiceSignature(TestInvoiceSignature, TestSubscription):
    def setUp(self):
        super().setUp()
        self.sale_subscription_cron = self.env.ref("gym_subscription.account_analytic_cron_for_invoice")
