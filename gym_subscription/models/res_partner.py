...
class ResPartner(models.Model):
    ...
    def open_related_subscription(self):
        ...
        if len(subscription_ids) == 1:
            ...
            action['views'] = [(self.env.ref('gym_subscription.sale_subscription_view_tree').id, 'list'), (self.env.ref('gym_subscription.sale_subscription_primary_form_view').id, 'form')]
            action['search_view_id'] = [self.env.ref('gym_subscription.sale_subscription_view_search').id]
        return action
