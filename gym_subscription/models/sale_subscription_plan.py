...
class SaleSubscriptionPlan(models.Model):
    ...
    def action_open_active_subscription_lines(self):
        ...
        return {
            ...
            'view_mode': 'list',
            'views': [(self.env.ref('gym_subscription.sale_subscription_sale_order_line_list').id, 'list')],
            'search_view_id': [self.env.ref('gym_subscription.sale_subscription_sales_order_line_filter').id],
