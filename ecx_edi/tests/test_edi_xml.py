...
class TestEcEdiXmls(TestEcEdiCommon):
    ...
    def test_xml_tree_in_withhold_suggested_tax_taxpayer_type(self):
        ...
        self.partner_a.l10n_ec_taxpayer_type_id = self.env.ref('ecx_edi.l10n_ec_taxpayer_type_13')
        self.get_and_test_xml_tree_in_withhold(
    ...
    def test_import_xml_vendor_bill(self):
        ...
        file_content = file_open('ecx_edi/tests/expected_files/vendor_bill.xml', 'rb').read()
    ...
    def test_import_authorization_xml_vendor_bill(self):
        ...
        file_content = file_open('ecx_edi/tests/expected_files/authorization_vendor_bill.xml', 'rb').read()
        attachment = self.env['ir.attachment'].create({
            'mimetype': 'application/xml',
            'raw': file_content,
            'name': 'test_vendor_bill',
