...
class TestEcEdiCommon(AccountEdiTestCommon):
    ...
    @AccountEdiTestCommon.setup_edi_format('ecx_edi.ecuadorian_edi_format')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def set_custom_taxpayer_type_on_partner_a(self):
        ...
        self.partner_a.l10n_ec_taxpayer_type_id = self.env.ref('ecx_edi.l10n_ec_taxpayer_type_01')
    ...
    def mock_zeep_client(self, expected_operations):
        """ A context manager to mock the API calls made by the EDI:
            ...
            - mock zeep.Client in `ecx_edi.models.account_edi_format`
        ...
        with (
            mock.patch('odoo.addons.ecx_edi.models.account_edi_format.Client', new=MockedClient),
            mock.patch.object(
