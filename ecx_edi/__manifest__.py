...
""",
    ...
    "data": [
        ...
        "views/ecx_edi_reimbursement_views.xml",
        "views/account_tax_view.xml",
        "views/product_view.xml",
        "views/ecx_edi_taxpayer_type_view.xml",
        "views/ecx_edi_certificate_views.xml",
        ...
        'wizard/ecx_edi_wizard_account_withhold_view.xml',
