...
class ResCompany(models.Model):
    ...
    ecx_edi_certificate_id = fields.Many2one(
    ...
    def _l10n_ec_is_demo_environment(self):
        return not self.l10n_ec_production_env and not self.sudo().ecx_edi_certificate_id
    ...
    def _l10n_ec_set_taxpayer_type_for_demo(self):
        ...
        type01 = self.env.ref('ecx_edi.l10n_ec_taxpayer_type_01').with_company(self)
        ...
        type06 = self.env.ref('ecx_edi.l10n_ec_taxpayer_type_06').with_company(self)
