...
class PortalWithholding(PortalAccount):
    ...
    def portal_my_invoices(self, page=1, date_begin=None, date_end=None, sortby=None, filterby=None, **kw):
        ...
        return request.render("ecx_edi.portal_my_withholdings", values)
    ...
    def portal_my_invoice_detail(self, invoice_id, access_token=None, report_type=None, download=False, **kw):
        ...
        if withholding_sudo._l10n_ec_is_withholding() and not download and report_type in ('html', 'pdf', 'text'):
            ...
            return self._show_report(model=withholding_sudo, report_type=report_type, report_ref='ecx_edi.ecx_edi_withhold', download=download)
