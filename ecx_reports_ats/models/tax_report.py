    ...
    def _get_purchase_values(self, date_start, date_finish):
        ...
        for in_inv in purchase_invoices:
            ...
            if transaction_type == '03':
                natural_society = in_inv.commercial_partner_id._get_ecx_edi_supplier_identification_type_code()
    ...
    def _get_invoices_values(self, date_start, date_finish):
        ...
        for invoice in invoices:
            ...
            is_manual = (
                ...
                or not any(edi_doc for edi_doc in invoice.edi_document_ids if edi_doc.edi_format_id == self.env.ref('ecx_edi.ecuadorian_edi_format'))
            )
